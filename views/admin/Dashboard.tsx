        ...
        <Card className="bg-slate-900/80 border border-slate-700/50 shadow-sm">
          <CardBody className="p-6">
            ...
            <div className="space-y-3">
              <button className="w-full text-left px-4 py-3 bg-slate-800/60 hover:bg-slate-800 rounded-lg transition-colors border border-slate-700/50">
                <p className="font-medium text-slate-200">添加 AI 模型</p>
                <p className="text-sm text-slate-500 mt-1">配置新的 AI 模型接口</p>
              </button>
              <button className="w-full text-left px-4 py-3 bg-slate-800/60 hover:bg-slate-800 rounded-lg transition-colors border border-slate-700/50">
                <p className="font-medium text-slate-200">查看用户列表</p>
          ...
          <CardBody className="p-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between py-2 border-b border-slate-700/50">
                ...
                <span className="font-medium text-emerald-400">已连接</span>
              </div>
              <div className="flex justify-between py-2">
                <span className="text-slate-400">最后更新</span>
                <span className="font-medium text-slate-200">刚刚</span>
              </div>
            </div>
          </CardBody>
        </Card>
